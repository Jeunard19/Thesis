...
<head>
    ...
    <title>Aframe Material Collection - Advanced Example</title>
</head>
<body>
<a-scene stats>
    <a-assets>
    ...
    <a-ui-renderer id="modalRenderer" ui-panel="#modalPanel">
        <a-entity geometry="primitive:plane;width:4.222;height:1.9;" material="side:double;shader:flat;" position="0 0 -0.495">
                ...
                <a-entity class="container">
                    ...
                    <a-entity width="1.35">
                        ...
                        <a-entity width="1.25">
                            ...
                            <a-text font="roboto" baseLine="center" value="Slider"
                                    color="#212121" anchor="center" wrap-count="25" width="1.25" height="0.1"></a-text>
                    ...
                    <a-entity width="1.35">
                        ...
                        <a-entity width="1.25">
                            ...
                            <a-ui-input-text camera-el="#camera" width="0.45" height="0.2" type="number"
                        ...
                        <!--Password Input-->
                        <a-entity width="1.25">
                            <a-text font="roboto" baseLine="center" anchor="center" value="Password"
                                    color="#212121" wrap-count="25" width="1.25" height="0.1"></a-text>

                            <a-ui-input-text camera-el="#camera" width="1" height="0.2" type="password"
                                             place-holder="Password..."></a-ui-input-text>
                        </a-entity>
                        <!--Switch-->
                        <a-entity width="1.25">
